...
<body style="background:url(/QQ-master/Application/Home/View/Public/css/background.jpg);background-size: cover; background-attachment:fixed;background-repeat:no-repeat;">
