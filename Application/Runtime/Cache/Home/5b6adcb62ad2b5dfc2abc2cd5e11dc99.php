...
<body style="background:url(/QQ-master/Application/Home/View/Public/css/login.jpg);background-size: cover; background-attachment:fixed;background-repeat:no-repeat;">
		   	...
		   	<div class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls" style="margin-left: 104px;">
						...
						<img src="<?php echo U('Code/getCode');?>" onclick="javascript:this.src='<?php echo U('Code/getCode');?>';" id="vcode">
					</div>
				</div>
				<div class="control-group">
